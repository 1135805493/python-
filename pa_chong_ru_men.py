...
Traceback (most recent call last):
  File "<pyshell#0>", line 1, in <module>
    import urllid2
ImportError: No module named urllid2
>>> import urllid2
...
var bds={
    ...
    comm : {
        ...
        query : "",
        qid : "ac6294e80000302d",
        cid : "0",
        sid : "1448_21083_17001_24879_20928",
        indexSid : "1448_21083_17001_24879_20928",
        stoken : "",
        serverTime : "1510640486",
        user : "",
        username : "",
        userid : "0",
        loginAction : [],
        ...
        pinyin : "",
        favoOn : "",
        cookie : {"BDRCVFR":{"iQ5-nrK5PtR":"aeXf-1x8UdYcs","W5Es5p2qqHR":"mk3SLVN4HKm","I7Jz_nx0Tk_":"_vEamOsdBPbrHbLnz4WUvY"},"BAIDUID":"374AC147E8D1132526498728C3BBFB30:FG=1","PSTM":"1504528817","BIDUPSID":"374AC147E8D1132526498728C3BBFB30","UM_distinctid":"15e19b14307335-0a1d019f013c85-66386d0e-f3000-15e19b1431641f","FP_UID":"33d3ec0c4c63bd34b94500bb774e2ab8","pgv_pvi":"4102610944","BDORZ":"FFFB88E999055A3F8A630C64834BD6D0","PSINO":"3","H_PS_PSSID":"1448_21083_17001_24879_20928","BDSVRTM":"0","BD_HOME":"0"},
        ...
        globalLogFlag:0
	,encTn:'97b6tvIiHLsOkBtYqrdfO/q0ZhqltkP2QG+r1GJJDuAEH17vKYD5h0frjyY'    }
};
...
>>> import urllib
>>> values = {"username":"1135805493@qq.com","password":"ce199842."}
...
<html>
  <head>
    ...
    <link type="text/css" rel="stylesheet" href="/css/bootstrap.css;jsessionid=3A2A10A0F847D4A7459832483CA08D00.tomcat1" />
    <link type="text/css" rel="stylesheet" href="/css/login.css;jsessionid=3A2A10A0F847D4A7459832483CA08D00.tomcat1" />
    <link type="text/css" rel="stylesheet" href="/css/weixinqr.css;jsessionid=3A2A10A0F847D4A7459832483CA08D00.tomcat1" />
  ...
  <body>
            ...
            <div class="login-part">
              ...
              <div class="user-info">
                <div class="user-pass">
                  ...
                  <form id="fm1" action="/account/login;jsessionid=3A2A10A0F847D4A7459832483CA08D00.tomcat1?from=http://my.csdn.net/my/mycsdn" method="post">
					...
					<input type="hidden" name="lt" value="LT-309210-5flJySN6FwQWIr2TzCdbuO9Zc1qLp9" />
              ...
              <div class="third-part tracking-ad" data-mod="popu_27">
              	...
              	<a id="qqAuthorizationUrl" href="https://graph.qq.com/oauth2.0/authorize?response_type=code&client_id=100270989&redirect_uri=https%3A%2F%2Fpassport.csdn.net%2Faccount%2Flogin%3Foauth_provider%3DQQProvider&state=test" class="qq"></a>
                   	...
                   	<script src="/js/apps/weixinqr.js;jsessionid=3A2A10A0F847D4A7459832483CA08D00.tomcat1"></script>
    ...
    <script data-main="/js/login-config.js;jsessionid=3A2A10A0F847D4A7459832483CA08D00.tomcat1" src="/js/libs/require.js;jsessionid=3A2A10A0F847D4A7459832483CA08D00.tomcat1"></script>
    <script type="text/javascript">
...
>>> values = {}
>>> values = ['username'] = "1135805493@qq.com"
SyntaxError: can't assign to literal
>>> values = ['username'] = "1135805493@qq.com"
SyntaxError: can't assign to literal
>>> values = ['username'] = "1135805493"
SyntaxError: can't assign to literal
>>> values['username'] = "1016903103@qq.com"
>>> values['username'] = "1135805493@qq.com"
>>> values['password']="ce199842."
>>> data = urllib.urlencode(values)
...
>>> response = urllib2.urlopen(request)
>>> print response.geturl()
http://passport.csdn.net/account/login?username=1135805493%40qq.com&password=ce199842.
>>> print response.read()
...
<html>
  <head>
    ...
    <link type="text/css" rel="stylesheet" href="/css/bootstrap.css;jsessionid=A60D01F786A71A2D7A980FF0110972EF.tomcat2" />
    <link type="text/css" rel="stylesheet" href="/css/login.css;jsessionid=A60D01F786A71A2D7A980FF0110972EF.tomcat2" />
    <link type="text/css" rel="stylesheet" href="/css/weixinqr.css;jsessionid=A60D01F786A71A2D7A980FF0110972EF.tomcat2" />
    <script src="https://res.wx.qq.com/connect/zh_CN/htmledition/js/wxLogin.js"></script>
    <!--[if lt IE 9]>
    <script src="https://oss.maxcdn.com/libs/html5shiv/3.7.0/html5shiv.js"></script>
    <script src="https://oss.maxcdn.com/libs/respond.js/1.3.0/respond.min.js"></script>
  ...
  <body>
            ...
            <div class="login-part">
              ...
              <div class="user-info">
                <div class="user-pass">
                  ...
                  <form id="fm1" action="/account/login;jsessionid=A60D01F786A71A2D7A980FF0110972EF.tomcat2?username=1135805493%40qq.com&amp;password=ce199842." method="post">
                    ...
                    <!-- 该参数可以理解成每个需要登录的用户都有一个流水号。只有有了webflow发放的有效的流水号，用户才可以说明是已经进入了webflow流程。否则，没有流水号的情况下，webflow会认为用户还没有进入webflow流程，从而会重新进入一次webflow流程，从而会重新出现登录界面。 -->
					<input type="hidden" name="lt" value="LT-312225-Xiux2IDbdmTO560AdcOkVAGKXW6sbK" />
			 		<input type="hidden" name="execution" value="e1s1" /> 
					<input type="hidden" name="_eventId" value="submit" /> 
					<input class="logging" accesskey="l" value="登 录" tabindex="6" type="button" /> 
              ...
              <div class="third-part tracking-ad" data-mod="popu_27">
              	...
              	<a id="qqAuthorizationUrl" href="https://graph.qq.com/oauth2.0/authorize?response_type=code&client_id=100270989&redirect_uri=https%3A%2F%2Fpassport.csdn.net%2Faccount%2Flogin%3Foauth_provider%3DQQProvider&state=test" class="qq"></a>
                   	...
                   	<a id="wechatAuthorizationUrl" href="javascript:void(0)" onClick="show();" class="wechat" target="_parent"></a>
                   	<script src="/js/apps/weixinqr.js;jsessionid=A60D01F786A71A2D7A980FF0110972EF.tomcat2"></script>
    ...
    <div class="footer"></div>
    <script data-main="/js/login-config.js;jsessionid=A60D01F786A71A2D7A980FF0110972EF.tomcat2" src="/js/libs/require.js;jsessionid=A60D01F786A71A2D7A980FF0110972EF.tomcat2"></script>
    <script type="text/javascript">
		document.write('<script type="text/javascript" src="//csdnimg.cn/pubfooter/js/publib_footer.js?' + Math.floor(new Date()/120000).toString(36) + '="></'+'script>');
	</script>
  </body>
